...
SUMMARY_SAVE_PATH = "resources/summaries/" + EXPERIMENT_NAME
CHECKPOINT_SAVE_PATH = "resources/tmp/" + EXPERIMENT_NAME + ".ckpt"
CHECKPOINT_NAME = "resources/tmp/breakout_a3c.ckpt-5"
